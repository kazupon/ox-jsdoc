...
Concrete optimization patterns adopted in ox-jsdoc's parser implementation. These are adapted from oxc_parser's performance design, tailored to ox-jsdoc's characteristics.
...
The type parser uses Pratt parsing and directly adapts these patterns from oxc_parser's expression parser:
