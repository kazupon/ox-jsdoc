...
use ox_jsdoc_origin::ast::JsdocType;
use ox_jsdoc_origin::parse_comment;
use ox_jsdoc_origin::parser::ParseOptions;
use ox_jsdoc_origin::type_parser::ast::ParseMode;
...
fn serialize_node(node: &ox_jsdoc_origin::type_parser::ast::TypeNode<'_>) -> serde_json::Value {
    use ox_jsdoc_origin::type_parser::ast::*;
    use serde_json::json;
...
fn quote_str(q: ox_jsdoc_origin::type_parser::ast::QuoteStyle) -> &'static str {
    match q {
        ox_jsdoc_origin::type_parser::ast::QuoteStyle::Single => "single",
        ox_jsdoc_origin::type_parser::ast::QuoteStyle::Double => "double",
    }
}

fn pos_str(p: ox_jsdoc_origin::type_parser::ast::ModifierPosition) -> &'static str {
    match p {
        ox_jsdoc_origin::type_parser::ast::ModifierPosition::Prefix => "prefix",
        ox_jsdoc_origin::type_parser::ast::ModifierPosition::Suffix => "suffix",
    }
}
