...
function getPostMessage(options) {
  return typeof (options === null || options === void 0 ? void 0 : options.postMessage) ===
    'function'
    ? options.postMessage
...
function deserizeErrorFromBuffer(sab) {
  ...
  var stackBuffer = buffer.slice(
    16 + nameLength + messageLength,
  ...
  var ErrorConstructor =
    (_a = globalThis[name]) !== null && _a !== void 0
      ? _a
      : name === 'RuntimeError'
        ? (_b = _WebAssembly.RuntimeError) !== null && _b !== void 0
          ? _b
          : Error
        : Error
...
function checkSharedWasmMemory(wasmMemory) {
  if (wasmMemory) {
    ...
    if (typeof SharedArrayBuffer === 'undefined') {
      throw new Error(
        'Current environment does not support SharedArrayBuffer, threads are not available!'
      )
    }
  }
}
function getReuseWorker(value) {
  ...
  if (!(size > 0) && strict) {
    throw new RangeError(
      'reuseWorker: size must be set to positive integer if strict is set to true'
    )
  }
  return { size, strict }
}
...
var ThreadManager = /* @__PURE__ */ (function () {
  function ThreadManager2(options) {
    ...
    this.printErr =
      (_a = options.printErr) !== null && _a !== void 0 ? _a : console.error.bind(console)
  }
  ...
  ThreadManager2.prototype.loadWasmModuleToAllWorkers = function () {
    ...
    var _loop_1 = function (i2) {
      ...
      promises[i2] = this_1.loadWasmModuleToWorker(worker).then(
        function (w) {
    ...
    worker.whenLoaded = new Promise(function (resolve2, reject) {
      ...
      if (ENVIRONMENT_IS_NODE) {
        worker.on('message', function (data) {
          var _a, _b
          ;(_b = (_a = worker).onmessage) === null || _b === void 0
            ? void 0
            : _b.call(_a, {
                data
              })
...
var WASIThreads = /* @__PURE__ */ (function () {
  function WASIThreads2(options) {
    ...
    if ('waitThreadStart' in options) {
      waitThreadStart =
        typeof options.waitThreadStart === 'number'
  ...
  WASIThreads2.prototype.setup = function (wasmInstance, wasmModule, wasmMemory) {
    wasmMemory !== null && wasmMemory !== void 0
      ? wasmMemory
...
function setupInstance(wasi, instance) {
  var _a = getWasiSymbol(wasi, ['kInstance', 'kSetMemory']),
    kInstance2 = _a[0],
    kSetMemory2 = _a[1]
...
function load(wasmInput, imports) {
  ...
  try {
    var then =
      typeof wasmInput === 'object' && wasmInput !== null && 'then' in wasmInput
        ? wasmInput.then
        : void 0
  ...
  var napiModule = (function () {
    ...
    var napiModule2 = {
      ...
      init: function (options2) {
        if (napiModule2.loaded) return napiModule2.exports
        if (!options2) throw new TypeError('Invalid napi init options')
        ...
        if (!(module instanceof _WebAssembly2.Module)) throw new TypeError('Invalid wasm module')
        if (!(memory instanceof _WebAssembly2.Memory)) throw new TypeError('Invalid wasm memory')
        if (!(table instanceof _WebAssembly2.Table)) throw new TypeError('Invalid wasm table')
        wasmMemory = memory
        wasmTable = table
        ...
        if (!napiModule2.childThread) {
          ...
          var node_api_module_get_api_version_v1 =
            instance.exports.node_api_module_get_api_version_v1
          if (typeof node_api_module_get_api_version_v1 === 'function') {
            moduleApiVersion = node_api_module_get_api_version_v1()
          }
          var envObject =
            napiModule2.envObject ||
    ...
    function _emnapi_get_node_version(major, minor, patch) {
      var versions =
        ...
        process.versions !== null &&
        typeof process.versions.node === 'string'
          ? process.versions.node.split('.').map(function (n) {
              return Number(n)
            })
          : [0, 0, 0]
    ...
    function _emnapi_callback_into_module(
      forceUncaught,
      env,
      callback,
      data,
      close_scope_if_throw
    ) {
      var envObject = emnapiCtx.envStore.get(env)
    ...
    function _emnapi_node_emit_async_init(
      ...
      var asyncContext = emnapiNodeBinding.node.emitAsyncInit(
        resource,
        resource_name,
        trigger_async_id
      )
    ...
    function _emnapi_node_make_callback(
      env,
      async_resource,
      cb,
      argv,
    ...
    function _emnapi_async_init_js(async_resource, async_resource_name, result) {
      ...
      if (
        !(
          numberValue >= BigInt(-1) * (BigInt(1) << BigInt(63)) &&
          numberValue < BigInt(1) << BigInt(63)
        )
      ) {
    ...
    var emnapiTSFN = {
      ...
      push: function (func, data, mode) {
        ...
        var isBrowserMain =
          typeof window !== 'undefined' && typeof document !== 'undefined' && !ENVIRONMENT_IS_NODE2
      ...
      getIsClosing: function (func) {
        return Atomics.load(
          ...
          (func + emnapiTSFN.offset.is_closing) >> 2
        )
      },
      ...
      getHandlesClosing: function (func) {
        return Atomics.load(
          new Int32Array(wasmMemory.buffer),
          (func + emnapiTSFN.offset.handles_closing) >> 2
        )
      },
    ...
    var emnapiString = {
      ...
      init: function () {
        ...
        var utf16Decoder
        utf16Decoder =
          typeof TextDecoder === 'function' ? new TextDecoder('utf-16le') : fallbackDecoder2
    ...
    function napi_get_value_int64(env, value, result) {
      ...
      } else if (numberValue /* INT64_RANGE_POSITIVE */ >= 9223372036854776e3) {
    ...
    function napi_create_string_latin1(env, str, length, result) {
      return emnapiString.newString(
        env,
        str,
        length,
        result,
        function (str2, autoLength, sizeLength) {
          var latin1String = ''
          var len = 0
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          if (autoLength) {
    ...
    function emnapi_create_memory_view(
      ...
      try {
        ...
        var typedArray =
          typedarray_type === -2
            ? emnapiCtx.feature.Buffer.from(
                wasmMemory.buffer,
                viewDescriptor.address,
                viewDescriptor.length
              )
    ...
    function $emnapiSyncMemory(js_to_wasm, arrayBufferOrView, offset, len) {
      ...
      if (
        ...
        emnapiExternalMemory.isSharedArrayBuffer(arrayBufferOrView)
      ) {
      ...
      throw new TypeError(
        'emnapiSyncMemory expect ArrayBuffer or ArrayBufferView as first parameter'
      )
    }
    function emnapi_sync_memory(env, js_to_wasm, arraybuffer_or_view, offset, len) {
      ...
      try {
        ...
        if (
          ...
          !handle.isTypedArray() &&
          !handle.isDataView() &&
          !emnapiExternalMemory.isSharedArrayBuffer(handle.value)
        ) {
          return envObject.setLastError(
            1
            /* napi_status.napi_invalid_arg */
    ...
    function $emnapiGetMemoryAddress(arrayBufferOrView) {
      ...
      if (
        ...
        throw new TypeError(
          'emnapiGetMemoryAddress expect ArrayBuffer or ArrayBufferView as first parameter'
        )
      }
      var info
      if (isArrayBuffer) {
    ...
    function emnapi_get_memory_address(
      env,
      arraybuffer_or_view,
      address,
      ownership,
    ...
    function napi_create_external_arraybuffer(
      ...
      try {
        ...
        if (byte_length === 0) {
          ...
          u8arr.set(
            new Uint8Array(wasmMemory.buffer).subarray(external_data, external_data + byte_length)
          )
    ...
    function napi_create_object_with_properties(
      ...
      var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
      for (var i = 0; i < property_count; i++) {
        var name_value = emnapiCtx.handleStore.get(
          HEAP_DATA_VIEW.getUint32(property_names + i * 4, true)
        ).value
        ...
        properties[name_value] = {
          value: emnapiCtx.handleStore.get(HEAP_DATA_VIEW.getUint32(property_values + i * 4, true))
            .value,
          writable: true,
          enumerable: true,
          configurable: true
    ...
    function node_api_create_buffer_from_arraybuffer(
      env,
      arraybuffer,
      byte_offset,
      byte_length,
    ...
    function addImports(mod) {
      ...
      for (var i = 0; i < keys.length; ++i) {
        ...
        if (k.indexOf('emnapi_') === 0) {
          ...
          k.indexOf('_emnapi_') === 0 ||
          k === 'napi_set_last_error' ||
          k === 'napi_clear_last_error'
        ) {
    ...
    napiModule2.imports.napi.napi_get_threadsafe_function_context =
  ...
  return loadFn(wasmInput, importObject, function (err, source) {
    ...
    if (napiModule.PThread.shouldPreloadWorkers()) {
      ...
      if (loadFn === loadCallback) {
        ...
        throw new Error(
          'Synchronous loading is not supported with worker pool (reuseWorker.size > 0)'
        )
      }
    }
    return emnapiInit()
...
function loadCallback(wasmInput, importObject, callback) {
  return load(wasmInput, importObject).then(
    function (source) {
...
var TrackedFinalizer = /* @__PURE__ */ (function (_super) {
  ...
  TrackedFinalizer2.create = function (envObject, finalize_callback, finalize_data, finalize_hint) {
    var finalizer = new TrackedFinalizer2(
      envObject,
      finalize_callback,
      finalize_data,
      finalize_hint
...
var NodeEnv = /* @__PURE__ */ (function (_super) {
  ...
  function NodeEnv2(
    ...
    var _this =
      _super.call(this, ctx, moduleApiVersion, makeDynCall_vppp, makeDynCall_vp, abort) || this
  ...
  NodeEnv2.prototype.callbackIntoModule = function (enforceUncaughtExceptionPolicy, fn) {
    return this.callIntoModule(fn, function (envObject, err) {
      ...
      var hasForceFlag = hasProcess
        ? Boolean(
            process.execArgv &&
            process.execArgv.indexOf('--force-node-api-uncaught-exceptions-policy') !== -1
          )
        : false
...
function newEnv(
  ...
  moduleApiVersion =
    typeof moduleApiVersion !== 'number' ? NODE_API_DEFAULT_MODULE_API_VERSION : moduleApiVersion
...
var Context = /* @__PURE__ */ (function () {
  ...
  Context2.prototype.createReferenceWithData = function (
    envObject,
    handle_id,
    initialRefcount,
    ownership,
  ...
  Context2.prototype.createTrackedFinalizer = function (
    envObject,
    finalize_callback,
    finalize_data,
    finalize_hint
...
function validateObject(value, name) {
  if (value === null || typeof value !== 'object') {
    throw new TypeError(
      `${name} must be an object. Received ${value === null ? 'null' : typeof value}`
    )
  }
}
function validateArray(value, name) {
  if (!Array.isArray(value)) {
    throw new TypeError(
      `${name} must be an array. Received ${value === null ? 'null' : typeof value}`
    )
  }
}
function validateBoolean(value, name) {
  if (typeof value !== 'boolean') {
    throw new TypeError(
      `${name} must be a boolean. Received ${value === null ? 'null' : typeof value}`
    )
  }
}
function validateString(value, name) {
  if (typeof value !== 'string') {
    throw new TypeError(
      `${name} must be a string. Received ${value === null ? 'null' : typeof value}`
    )
  }
}
function validateFunction(value, name) {
  if (typeof value !== 'function') {
    throw new TypeError(
      `${name} must be a function. Received ${value === null ? 'null' : typeof value}`
    )
  }
}
function validateUndefined(value, name) {
  if (value !== void 0) {
    throw new TypeError(
      `${name} must be undefined. Received ${value === null ? 'null' : typeof value}`
    )
  }
}
...
var FileDescriptorTable = class {
  ...
  get(id, base, inheriting) {
    ...
    if (
      (~entry.rightsBase & base) !== BigInt(0) ||
      (~entry.rightsInheriting & inheriting) !== BigInt(0)
    ) {
      throw new WasiError(
...
function syscallWrap(self2, name, f) {
  ...
  return debug
    ? defineName(name, function () {
        ...
        let debugArgs = [
          `${name}(${Array.from({ length: arguments.length })
            .map(() => '%d')
            .join(', ')})`
        ]
...
var WASI$1 = class _WASI$1 {
  constructor(args, env, fds, asyncFs, fs, asyncify) {
    ...
    this.fd_fdstat_set_rights = syscallWrap(
      this,
      'fd_fdstat_set_rights',
      function (fd, rightsBase, rightsInheriting) {
        const wasi = _wasi.get(this)
        const fileDescriptor = wasi.fds.get(fd, BigInt(0), BigInt(0))
        ...
        if (
          (rightsInheriting | fileDescriptor.rightsInheriting) >
    ...
    this.fd_prestat_dir_name = syscallWrap(
      this,
      'fd_prestat_dir_name',
      function (fd, path, path_len) {
        path = Number(path)
    ...
    this.poll_oneoff = syscallWrap(
      this,
      'poll_oneoff',
      function (in_ptr, out_ptr, nsubscriptions, nevents) {
    ...
    function defineImport(name, syncVersion, asyncVersion, parameterType, returnType) {
      if (asyncFs) {
        if (asyncify) {
          ...
          _this[name] = wrapAsyncImport(
            syscallWrap(_this, name, asyncVersion),
            parameterType,
            returnType
          )
        }
    ...
    defineImport(
      ...
      function fd_pwrite(fd, iovs, iovslen, offset, size) {
        ...
        const buffer = concatBuffer(
          Array.from({ length: Number(iovslen) }, (_, i) => {
            const offset2 = iovs + i * 8
            const buf = view.getInt32(offset2, true)
            const bufLen = view.getUint32(offset2 + 4, true)
            return HEAPU8.subarray(buf, buf + bufLen)
      ...
      async function fd_pwrite(fd, iovs, iovslen, offset, size) {
        ...
        const { bytesWritten } = await fileDescriptor.fd.write(
          buffer,
          0,
          buffer.length,
          Number(offset)
    ...
    defineImport(
      ...
      function fd_read(fd, iovs, iovslen, size) {
        ...
        if (fd === 0) {
          ...
          buffer._isBuffer = true
          const fs2 = getFs(this)
          const bytesRead = fs2.readSync(
            fileDescriptor.fd,
            buffer,
            0,
            buffer.length,
            Number(fileDescriptor.pos)
          )
          nread = buffer ? copyMemory(ioVecs, buffer.subarray(0, bytesRead)) : 0
      ...
      async function fd_read(fd, iovs, iovslen, size) {
        ...
        if (fd === 0) {
          ...
          buffer._isBuffer = true
          const { bytesRead } = await fileDescriptor.fd.read(
            buffer,
            0,
            buffer.length,
            Number(fileDescriptor.pos)
    ...
    defineImport(
      ...
      function fd_readdir(fd, buf, buf_len, cookie, bufused) {
        ...
        for (let i = Number(cookie); i < entries.length; i++) {
          ...
          const entryInfo = fs2.statSync(resolve(fileDescriptor.realPath, entries[i].name), {
            bigint: true
          })
      ...
      async function fd_readdir(fd, buf, buf_len, cookie, bufused) {
        ...
        for (let i = Number(cookie); i < entries.length; i++) {
          const nameData = encoder.encode(entries[i].name)
          const entryInfo = await fs2.promises.stat(
    ...
    defineImport(
      ...
      async function fd_write(fd, iovs, iovslen, size) {
        ...
        if (fd === 1 || fd === 2) {
          ...
          nwritten = await (
            await fileDescriptor.fd.write(buffer, 0, buffer.length, Number(fileDescriptor.pos))
          ).bytesWritten
          fileDescriptor.pos += BigInt(nwritten)
        }
        view.setUint32(size, nwritten, true)
    ...
    defineImport(
      ...
      function path_open(
        ...
        const { base: max_base, inheriting: max_inheriting } = getRights(
          wasi.fds.stdio,
          r,
          flagsRes,
          filetype
...
var WASI = class {
  ...
  finalizeBindings(instance, _a) {
    var _b
    var {
      memory = (_b = instance === null || instance === void 0 ? void 0 : instance.exports) ===
        null || _b === void 0
        ? void 0
        : _b.memory
    } = _a === void 0 ? {} : _a
